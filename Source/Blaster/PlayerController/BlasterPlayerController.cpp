...
void ABlasterPlayerController::BeginPlay()
{
	...
	if (APlayerController* PC = Cast<APlayerController>(this))
	{
		...
		{
			if (InputMappingContext) // Assume InputMappingContext is a UInputMappingContext*
			{
...
void ABlasterPlayerController::PollInit()
{
	...
	// fix for server client not able to control the character
	ABlasterPlayerController* BlasterPlayerController = IsValid(this) ? Cast<ABlasterPlayerController>(this) : nullptr;
	if (BlasterPlayerController)
	{
		ABlasterCharacter* BlasterControlledCharacter = Cast<ABlasterCharacter>(BlasterPlayerController->GetPawn());
		if (BlasterControlledCharacter)
		{
			BlasterControlledCharacter->SetupPlayerInput();
		}
	}
}
...
void ABlasterPlayerController::SetupInputComponent()
{
	...
	if (EnhancedInputComp == nullptr) return;

	if (QuitAction)
	{
		EnhancedInputComp->BindAction(QuitAction, ETriggerEvent::Triggered, this, &ABlasterPlayerController::ShowReturnToMainMenu);
	}
}
